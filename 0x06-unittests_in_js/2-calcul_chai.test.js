...
describe("calculateNumber", () => {
  describe("type == SUM", () => {
    ...
    it("correctly rounds down a's fractional part with trailing 9s", () => {
      expect(calculateNumber("SUM", 3.49999, 4)).to.equal(7);
    });
  });
  ...
  describe("type == SUBTRACT", () => {
    ...
    it("correctly rounds down b's fractional part with trailing 9s", () => {
      expect(calculateNumber("SUBTRACT", 3.4, 4.4999999)).to.equal(-1);
    });
    it("correctly rounds down a's fractional part with trailing 9s", () => {
      expect(calculateNumber("SUBTRACT", 3.49999, 4)).to.equal(-1);
    });
  });
  ...
  describe("type == DIVIDE", () => {
    ...
    it("correctly rounds down b's fractional part with trailing 9s", () => {
      expect(calculateNumber("DIVIDE", 6, 3.4999999)).to.equal(2);
    });
    it("correctly rounds down a's fractional part with trailing 9s", () => {
      expect(calculateNumber("DIVIDE", 6.49999, 3)).to.equal(2);
    });
    ...
    it("returns the string error when b is 0", () => {
      expect(calculateNumber("DIVIDE", 6.44, 0)).to.equal("Error");
    });
  });
});
